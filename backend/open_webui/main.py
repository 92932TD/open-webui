...
app.state.config.CODE_EXECUTION_MARIMO_URL = CODE_EXECUTION_MARIMO_URL
app.state.config.CODE_EXECUTION_MARIMO_AUTH = CODE_EXECUTION_MARIMO_AUTH
app.state.config.CODE_EXECUTION_MARIMO_AUTH_TOKEN = CODE_EXECUTION_MARIMO_AUTH_TOKEN
app.state.config.CODE_EXECUTION_MARIMO_AUTH_PASSWORD = CODE_EXECUTION_MARIMO_AUTH_PASSWORD
app.state.config.CODE_EXECUTION_MARIMO_TIMEOUT = CODE_EXECUTION_MARIMO_TIMEOUT
...
app.state.config.CODE_INTERPRETER_MARIMO_URL = CODE_INTERPRETER_MARIMO_URL
app.state.config.CODE_INTERPRETER_MARIMO_AUTH = CODE_INTERPRETER_MARIMO_AUTH
app.state.config.CODE_INTERPRETER_MARIMO_AUTH_TOKEN = CODE_INTERPRETER_MARIMO_AUTH_TOKEN
app.state.config.CODE_INTERPRETER_MARIMO_AUTH_PASSWORD = CODE_INTERPRETER_MARIMO_AUTH_PASSWORD
app.state.config.CODE_INTERPRETER_MARIMO_TIMEOUT = CODE_INTERPRETER_MARIMO_TIMEOUT
